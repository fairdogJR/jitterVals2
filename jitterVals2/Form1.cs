...
namespace jitterVals2
{
    ...
    public partial class Form1 : Form
    {
        ...
        Auction test1 = new Auction();// add the object instance here
...
//noise panel
        ...
        public void button3_Click_1(object sender, EventArgs e)
        {
           ...
           {"base_volts"        ,base_volts.ToString(),      " "}
            ...
            {
              string[]  row = new string[] { array2Db[i,0], array2Db[i,1], array2Db[i,2] };
        ...
        private void button6_Click_1(object sender, EventArgs e)//test code remove later
        {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            test1.Points[0] = 1234;
            test1.ShowPoints();
            Console.WriteLine(test1.array2Db[1, 0]);
        }


    }

    public class Auction //this is test code, can be removed later
    {
        ...
        public string[,] array2Db { get; set; }
        public Auction()
        {
            Points = new int[4];
